 ...
 *
 * @author makejava
 * @since 2021-06-15 20:22:13
 */
@Mapper
public interface BsByShopDao {
     ...
     * @return 对象列表
     */
    List<BsByShop> queryAllByLimit(@Param("offset") int offset, @Param("limit") int limit);
     ...
     * @return 对象列表
     */
    List<BsByShop> queryAll(BsByShop bsByShop);
